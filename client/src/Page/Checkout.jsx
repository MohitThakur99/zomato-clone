...
const Checkout = () => {
  ...
  const payNow = async () => {
      let options = {
        key: "rzp_test_x4Q8D6evl4wR5I", // Enter the Key ID generated from the Dashboard
        amount: reduxStateCart.reduce((acc, curVal) => acc + curVal.totalPrice, 0)*100, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
        currency: "INR",
        name: "Zomato Clone", //your business name
        ...
        prefill: {
          ...
          name: reduxStateUser.fullname, //your customer's name
  ...
  return (
    <>
      <div className="my-3 flex flex-col gap-3 items-center">
        ...
        <div className="w-full md:w-4/5 rounded-lg py-3 shadow-lg bg-white flex flex-col items-center">
          <h3 className="text-lg font-semibold">Summary</h3>
          <div className="flex w-full flex-col gap-2 items-center">
            <h5 className="text-base tracking-wider">ORDER FROM</h5>
            <div className="flex w-full flex-col items-center text-gray-400">
              <h4>Domino's Pizza</h4>
              <small>BikanerwalaNew Delhi</small>
            </div>
